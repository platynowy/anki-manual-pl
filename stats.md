...
Anki 2.1.28+ wprowadza nowe, przeprojektowane wykresy. Stare wykresy dalej są dostępne, poprzez przytrzymanie przycisku Shift podczas podczas otwierania statystyk (kliknięcia na przycisk "Statystyki").
...
Kliknięcie na "Zapisz jako PDF" zapisze dokument pdf ze statystykami na twoim pulpicie, aby łatwiej można było udostępniać swoje statystyki z innymi.
...
**cid**  
Numer ID karty, która została powtórzona. Możesz sprawdzić tę wartość w polu ID (id field) w tabelii "karty", aby uzyskqć więcej informacji o karcie. Jednak miej na uwadze, że karta mogła zostać zmieniona pomiędzy czasem, gdy wpis do "revlog" został dodany, a kiedy ty go przeglądasz.
